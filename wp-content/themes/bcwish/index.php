              ...
              <div class="col-md-12 wizard">
                ...
                <div class="row wizard_test hidden">
                  ...
                  <div class="col-sm-12 test_level_3 hidden" style="text-align: center;">
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_2">Грусть, тоска, дисфория</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_3">Беспокойство, страх сердцебеение, изжога</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_4">Злость, возбуждение, бессонница,плохие сновидения</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_5">Гармональные нарушения, снижение либидо</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_6">Головные боли</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_7">Дилеммы, неудачи</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_8">Обиды, переживания вины</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_9">Неуверенность в себе, сомнения</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_10">Переживания несправедливости</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_11">Проблемы пищеварения, запоры</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_11">Переживания несправедливости</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_12">Проблемы с поясницей</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_13">Проблемы с шеей</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_14">Накопление кармы</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_15">Сглаз, порча</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_16">Алергия</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_17">Упадок сил</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_18">Перевозбуждение на полнолуние</div>
                  </div>
                  <!-- <div class="col-sm-12" style="text-align: center;">
