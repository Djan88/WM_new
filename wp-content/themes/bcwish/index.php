        ...
        <nav class="main-nav float-right d-none d-lg-block">
          <ul>
            ...
            <li>
              ...
              <li><a href="<?php echo home_url(); ?>/?am_force_theme_layout=mobile">Мобильная версия</a></li>
            </li>
                ...
                <?php } else if (current_user_can('contributor') || current_user_can('administrator') || (current_user_can('subscriber') && $new_registred == 1)) { ?>
                  ...
                  <div>
                    ...
                    <div class="for_desktop">
                      ...
                      <?php if (current_user_can('contributor') || current_user_can('administrator')){ ?>
                       <span class="arrow_title main_arrow_title">Начните работу с загрузки фото человека или плана помещения. <a target="_blank" href="https://youtu.be/fzaWUCoDGbk">(учебное видео)</a></span>
                      <?php } else { ?>
                        <span class="arrow_title main_arrow_title">Начните работу с загрузки фото человека. <a target="_blank" href="https://youtu.be/fzaWUCoDGbk">(учебное видео)</a></span>
                      <?php } ?> 
                    </div>
              ...
              <div class="col-md-12 wizard">
                    ...
                    <ul id="faq-list" class="wow fadeInUp">
                      <li>
                        ...
                        <div id="faq0" class="collapse" data-parent="#faq-list">
                          ...
                          <p class="hidden cur_moon_day">Сегодня <span class="cur_moon_day_val"></span> лунный день.</p>
							<p class="hidden">
								(Возможно расхождение до 0,5 лунного дня из-за погрешности в определении географических координат. Так как переход между прорабатываемыми зонами происходит плавно, это не оказывает существенного влияния на резуальтат работы программы)
							</p>
                          <?php if (current_user_can('subscriber') && $new_registred == 1) { ?>
                ...
                <div class="row wizard_diag testing_p hidden">
                  ...
                  <div class="col-sm-12 zone_recommend hidden">
                    <span class="zone_recommend_text"></span><button type="button" class="zones_reset btn btn-sm btn-warning" style="margin-right: 5px;">Сбросить <i class="fa fa-trash"></i></button><button type="button" class="btn_test_accept btn btn-sm btn-primary">Применить <i class="fa fa-check"></i></button>
                  </div>
                  <?php } ?>
                  <div class="col-sm-12" style="text-align: center;">
                ...
                <div class="row wizard_test hidden">
                  ...
                  <div class="col-sm-12 test_level_3 hidden" style="text-align: center;">
                    ...
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_3" data-index = '1_1_3'>Беспокойство, страх сердцебеение, изжога</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_4" data-index = '1_1_4'>Злость, возбуждение, бессонница,плохие сновидения</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_5" data-index = '1_1_5'>Гармональные нарушения, снижение либидо</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_6" data-index = '1_1_6'>Головные боли</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_7" data-index = '1_1_7'>Дилеммы, неудачи</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_8" data-index = '1_1_8'>Обиды, переживания вины</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_9" data-index = '1_1_9'>Неуверенность в себе, сомнения</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_10" data-index = '1_1_10'>Переживания несправедливости</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_11" data-index = '1_1_11'>Проблемы пищеварения, запоры</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_12" data-index = '1_1_12'>Проблемы с поясницей</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_13" data-index = '1_1_13'>Проблемы с шеей</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_14" data-index = '1_1_14'>Накопление кармы</div>
                    <div class="btn btn-sm btn-primary test_item test_item_1_1_15" data-index = '1_1_15'>Сглаз, порча</div>
    ...
    <div class="modal fade" id="w_error" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-text">
            <div class="row" style="text-align: center;padding: 20px;font-size: 40px;">
              ...
              <div class="col-sm-12">
                Ширина экрана устройства не должна быть меньше 600px. Для работы на небольших планшетах и смартфонах предусмотрена "Мобильная версия". <a href="<?php echo home_url(); ?>/?am_force_theme_layout=mobile">Переключиться на Мобильную версию</a>
              </div>
