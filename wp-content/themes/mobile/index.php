					...
					<div class="col text_center">
						...
						<div class="row">
							...
							<div class="col-sm-12 zone_recommend hidden">
							  <span class="zone_recommend_text"></span><button type="button" class="zones_reset btn btn-sm btn-warning" style="margin-right: 5px;">Сбросить <i class="fa fa-trash"></i></button><button type="button" class="btn_protocols btn btn-sm btn-success">Применить <i class="fa fa-check"></i></button>
							</div>
							<?php } ?>
						</div>
					</div>
